        ...
        if (LogitechGSDK.LogiUpdate() && LogitechGSDK.LogiIsConnected(0))
        {
            ...
            for (int i = 0; i < 128; i++)
            {
                if (rec.rgbButtons[i] == 128)
                {
                    ...
                    buttonStatus += "Button gg" + i + " pressed\n";
            ...
            //Fuerza del amortiguador -> D
            if (Input.GetKeyUp(KeyCode.D))
            {
                Debug.Log("Fuerza del amortiguador D");
            ...
            //            Fuerza de colisión lateral -> flecha izquierda o derecha
            ...
            //Fuerza de colisión frontal -> flecha hacia arriba
            ...
            //            Efecto de carretera llena de baches-> B
            ...
            //Efecto de carretera resbaladiza-> L
